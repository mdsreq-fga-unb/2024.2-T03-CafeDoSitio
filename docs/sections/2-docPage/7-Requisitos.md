...
**RQNF02 -** A interface deve exibir os produtos da empresa em categorias organizadas e definidas pelas stakeholders, como produtos premium, cappuccino, etc. Permitindo que o usuário identifique cada item.<br>
...
**RQNF06 -** As instruções do e-commerce devem ser apresentadas com linguagem direta e suporte de elementos visuais, como ícones e guias passo a passo, para facilitar a compreensão dos usuários. <br>
